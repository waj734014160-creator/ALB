"""Exact pre-0.3 reference for every public ALB runtime family."""
...
REFERENCE_JSON = ROOT / "refs" / "alb_runtime_families_reference_v1.json"
REFERENCE_NPZ = ROOT / "refs" / "alb_runtime_families_reference_v1.npz"
...
def test_alb_runtime_families_match_reference_exactly() -> None:
    """Protect all runtime numerics before lifecycle ownership moves."""
