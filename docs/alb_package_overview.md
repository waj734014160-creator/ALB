...
- Run-number and path placement rules are repository workflow documentation, not
  ALB numerical package code. Keep the human-facing rules in `docs/run_index.md`
  and active run locator state in the owning project's current-status document.
