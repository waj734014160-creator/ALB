...
| `BearingConfig` | 类 | 严格校验、深度冻结的 0.4 轴承配置，支持安全覆盖、扫描和序列化。 | `ALB/api/config.py:565` |
...
| `load_bearing_config` | 函数 | 读取严格 UTF-8 0.4 bearing 文档，安全合并受限 include 并完成校验。 | `ALB/api/config.py:801` |
