...
- 状态：Superseded；0.3 决定已由 ADR-0006 的 0.4 无兼容接口替代。
...
> 本 ADR 保留用于追溯 0.3 设计。0.4 当前决定见
> [ADR-0006](0006-alb-0-4-no-legacy-friendly-api.md)，不得再用本文的兼容
> adapter、公开内部 `init()` 或 BuiltBearing 联合指导新增实现。
